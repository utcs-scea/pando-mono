...
bool atomicCompareExchangeImpl(GlobalPtr<T> ptr, GlobalPtr<T> expected, GlobalPtr<const T> desired,
  ...
  const auto foundValue = DrvAPI::atomic_cas<T>(ptr.address, expectedValue, desiredValue, DrvAPI::program_stage, DrvAPI::program_phase);
...
T atomicCompareExchangeImpl(GlobalPtr<T> ptr, T expected, const T desired) {
  ...
  return DrvAPI::atomic_cas<T>(ptr.address, expected, desired, DrvAPI::program_stage, DrvAPI::program_phase);
...
void atomicIncrementImpl(GlobalPtr<T> ptr, T value, [[maybe_unused]] std::memory_order order) {
  ...
  DrvAPI::atomic_add(ptr.address, value, DrvAPI::program_stage, DrvAPI::program_phase);
...
void atomicDecrementImpl(GlobalPtr<T> ptr, T value, [[maybe_unused]] std::memory_order order) {
  ...
  DrvAPI::atomic_add(ptr.address, static_cast<T>(-1) * value, DrvAPI::program_stage, DrvAPI::program_phase);
...
T atomicFetchAddImpl(GlobalPtr<T> ptr, T value, [[maybe_unused]] std::memory_order order) {
  ...
  return DrvAPI::atomic_add(ptr.address, value, DrvAPI::program_stage, DrvAPI::program_phase);
...
T atomicFetchSubImpl(GlobalPtr<T> ptr, T value, [[maybe_unused]] std::memory_order order) {
  ...
  return DrvAPI::atomic_add(ptr.address, static_cast<T>(-1) * value, DrvAPI::program_stage, DrvAPI::program_phase);
