...
#define PRI_ADDR PRIx64
    ...
    {
    public:
        Read(Addr physAddr, uint64_t size, flags_t flags = 0, Addr virtAddr = 0, Addr instPtr = 0, uint32_t tid = 0, int userID = 0) :
            Request(flags),
            pAddr(physAddr),
            vAddr(virtAddr),
            size(size),
    ...
    public:
        ...
        Write(
            ...
            Addr virtAddr = 0, Addr instPtr = 0, uint32_t tid = 0, int userID = 0) :
            Request(flags),
            pAddr(physAddr),
            vAddr(virtAddr),
            size(size),
