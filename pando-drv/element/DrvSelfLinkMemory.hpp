...
public:
  ...
  SST_ELI_REGISTER_SUBCOMPONENT(SST::Drv::DrvSelfLinkMemory, "Drv", "DrvSelfLinkMemory",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0), "Memory with fixed latency",
                                SST::Drv::DrvMemory)

  // document the parameters that this component accepts
  SST_ELI_DOCUMENT_PARAMS({"size", "Size of the memory", "0"}, )
  // register ports
  SST_ELI_DOCUMENT_PORTS({"port", "Self link to memory", {"Drv.DrvSelfLinkMemory.Event"}}, )
  /**
