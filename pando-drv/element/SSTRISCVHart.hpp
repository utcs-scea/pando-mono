...
public:
  ...
  reset_handle reset() {
    return reset_handle(*this);
  }
  const_reset_handle reset() const {
    return const_reset_handle(*this);
  }
   ...
   */
  bool& stalledMemory() {
    return _stalled_memory;
  }
  bool stalledMemory() const {
    return _stalled_memory;
  }
