 ...
 */
void DrvSimpleMemory::sendReadRequest(DrvCore* core, DrvThread* thread,
 ...
 */
void DrvSimpleMemory::sendWriteRequest(DrvCore* core, DrvThread* thread,
 ...
 */
void DrvSimpleMemory::sendAtomicRequest(
    DrvCore* core, DrvThread* thread, const std::shared_ptr<DrvAPI::DrvAPIMemAtomic>& atomic_req) {
 ...
 */
void DrvSimpleMemory::sendRequest(DrvCore* core, DrvThread* thread,
                                  const std::shared_ptr<DrvAPI::DrvAPIMem>& thread_mem_req) {
