...
public:
  ...
  SST_ELI_REGISTER_SUBCOMPONENT(SST::Drv::DrvSimpleMemory, "Drv", "DrvSimpleMemory",
                                SST_ELI_ELEMENT_VERSION(1, 0, 0), "Simple memory with no latency",
                                SST::Drv::DrvMemory)
  // document the parameters that this component accepts
  SST_ELI_DOCUMENT_PARAMS({"size", "The size of the memory", "1024"}, )
