...
public:
     ...
     */
    uint64_t getBase(uint32_t pxn, uint32_t pod, uint32_t core) const  override { return base_; }

    /**
     * @brief set the section base
     */
    void setBase(uint64_t base, uint32_t pxn, uint32_t pod, uint32_t core)  override { base_ = base; }
