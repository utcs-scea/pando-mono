...
public:
  ...
  DrvAPIAddress getAddress() const {
    return address_;
  }
...
public:
  DrvAPIMemRead(DrvAPIAddress address) : DrvAPIMem(address) {}
...
public:
  DrvAPIMemReadConcrete(DrvAPIAddress address) : DrvAPIMemRead(address) {}
...
public:
  DrvAPIMemWrite(DrvAPIAddress address) : DrvAPIMem(address) {}
...
public:
  DrvAPIMemWriteConcrete(DrvAPIAddress address, T value) : DrvAPIMemWrite(address), value_(value) {}
...
public:
  DrvAPIMemAtomic(DrvAPIAddress address) : DrvAPIMem(address) {}
  virtual void getPayload(void* p) = 0;
  virtual void setPayload(void* p) = 0;
  virtual void getResult(void* p) = 0;
  virtual void setResult(void* p) = 0;
...
public:
  ...
  DrvAPIMemAtomicType getOp() const override {
    return OP;
  }
...
public:
  ...
  DrvAPIToNativePointer(DrvAPIAddress address)
      : DrvAPIMem(address), native_pointer_(nullptr), region_size_(0) {}
