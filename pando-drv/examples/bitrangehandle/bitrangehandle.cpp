...
int AddrMapMain(int argc, char* argv[]) {
  ...
  printf("l2sbase_global = %s (%016" PRIx64 ")\n", l2sbase_global.to_string().c_str(),
         l2sbase_global.encode());
  ...
  printf("l2spbase_phys       = %s (%016" PRIx64 ")\n", l2spbase_phys.to_string().c_str(),
         l2spbase_phys.encode());
  printf("l2sbase_global_phys = %s (%016" PRIx64 ")\n", l2sbase_global_phys.to_string().c_str(),
         l2sbase_global_phys.encode());
  return 0;
}
