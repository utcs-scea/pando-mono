...
public:
  ...
  RISCVHart() : _rm(FE_TONEAREST), _pc(0) {
  ...
  public:
    reference_handle(ScalarT& ref, bool zero = false) : _ref(ref), _zero(zero) {}
    operator ScalarT() const {
      return _zero ? static_cast<ScalarT>(0) : _ref;
    }
  ...
  public:
    const_reference_handle(const ScalarT& ref, bool zero = false) : _ref(ref), _zero(zero) {}
    operator ScalarT() const {
      return _zero ? static_cast<ScalarT>(0) : _ref;
    }
    const ScalarT& _ref;
  ...
  public:
    fp_reference_handle(InternalFPType& ref) : _ref(ref) {}

    operator FPType() const {
      return static_cast<FPType>(_ref);
    }
  ...
  public:
    const_fp_reference_handle(const InternalFPType& ref) : _ref(ref) {}
