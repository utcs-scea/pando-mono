...
inline int32_t atomic_compare_and_swap_i32(volatile int32_t* ptr, int32_t oldval, int32_t newval) {
...
inline int64_t atomic_compare_and_swap_i64(volatile int64_t* ptr, int64_t oldval, int64_t newval) {
  // address to rs1 (= t3 [x28])
  // newval  to rs2 (= t4 [x29])
  // oldval  to rs3 (= t5 [x30])
  // output  to rd  (= t6 [x31])
