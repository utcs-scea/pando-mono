...
// 1) Added userID and acmPassCheck member variables as part of memEventBase class
// 2) Copy userID and acmPassCheck from event to responses
...
public:
    ...
    void setResponse(MemEventBase * event) {
        ...
        userID_ = event->userID_;
        acmPassCheck_ = event->acmPassCheck_;
    }
    ...
    virtual void copyMetadata(MemEventBase* ev) {
        ...
        userID_ = ev->userID_;
        acmPassCheck_ = ev->acmPassCheck_;
    }
    ...
    void setAcmPassCheck(bool acmPass) { acmPassCheck_ = acmPass; }
    bool getAcmPassCheck()             { return acmPassCheck_; }
