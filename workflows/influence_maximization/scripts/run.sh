...
K="${K:-50}"
RRR_SETS="${RRR_SETS:-100000}"
SEED="${SEED:-9801}"
COMMERCIAL_FILE="${COMMERCIAL_FILE:-data/scale0/commercial.csv}"
CYBER_FILE="${CYBER_FILE:-data/scale0/cyber.csv}"
SOCIAL_FILE="${SOCIAL_FILE:-data/scale0/social.csv}"
USES_FILE="${USES_FILE:-data/scale0/uses.csv}"
LOGFILE="${LOGFILE:-data/scale0_run.txt}"
